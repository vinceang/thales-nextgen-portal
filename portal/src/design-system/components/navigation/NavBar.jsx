 ...
 * The home button is a standard nav affordance; wire it up with `onHome`.
 */
export function NavBar({ title, logo, onMenu, onHome, wifiActive = true, onSearch, onProfile, className, style, ...rest }) {
  return (
